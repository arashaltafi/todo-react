    ...
    <div className="w-full h-screen flex flex-row overflow-hidden">
      <div className="h-full flex flex-col items-center justify-between bg-slate-100 px-8 py-4">
        ...
        <div className="w-full flex-1 flex items-center justify-center flex-col gap-8">
          <div className="w-full flex flex-row items-center justify-start gap-4 cursor-pointer hover:bg-purple-200 rounded-2xl px-4 py-2 group transition-all duration-150">
            <TaskAltIcon className="group-hover:text-purple-500" />
            <h3 className="text-2xl group-hover:text-purple-500">Tasks</h3>
          </div>
          <div className="w-full flex flex-row items-center justify-start gap-4 cursor-pointer hover:bg-purple-200 rounded-2xl px-4 py-2 group transition-all duration-150">
            <CategoryIcon className="group-hover:text-purple-500" />
            <h3 className="text-2xl group-hover:text-purple-500">Categories</h3>
          </div>
          <div className="w-full flex flex-row items-center justify-start gap-4 cursor-pointer hover:bg-purple-200 rounded-2xl px-4 py-2 group transition-all duration-150">
            <DeleteIcon className="group-hover:text-purple-500" />
            <h3 className="text-2xl group-hover:text-purple-500">Delete All</h3>
          </div>
        </div>
      </div>
